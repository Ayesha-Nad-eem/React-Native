...
module.exports = () => {
  ...
  expo.extra.FINNHUB_KEY =
    process.env.FINNHUB_KEY || expo.extra.FINNHUB_KEY || "";
  expo.extra.GOOGLE_MAPS_API_KEY =
    process.env.GOOGLE_MAPS_API_KEY || expo.extra.GOOGLE_MAPS_API_KEY || "";
  expo.extra.TOLLGURU_KEY =
    process.env.TOLLGURU_KEY || expo.extra.TOLLGURU_KEY || "";
  expo.extra.TOLL_PROVIDER =
    process.env.TOLL_PROVIDER || expo.extra.TOLL_PROVIDER || "heuristic";
  expo.extra.API_URL =
    process.env.API_URL || expo.extra.API_URL || "http://192.168.1.100:3000";
  expo.extra.STRIPE_PUBLISHABLE_KEY =
